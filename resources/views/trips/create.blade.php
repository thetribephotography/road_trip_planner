...
<script>
    var mapCenter = [{{ request('latitude', config('destination.map_center_latitude')) }}, {{ request('longitude', config('destination.map_center_longitude')) }}];
    var map = L.map('mapid').setView(mapCenter, {{ config('destination.zoom_level') }});
